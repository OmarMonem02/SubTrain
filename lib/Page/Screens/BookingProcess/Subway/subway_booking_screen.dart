...
class SubwayBookingScreenState extends State<SubwayBookingScreen> {
  ...
  String start = 'Adly Mansour'; // Initial start station
  String end = 'Helwan'; // Initial end station
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cairo Metro Path Finder'),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Display the path and length
            Expanded(
                child: SingleChildScrollView(child: Text(path.join(' \n ')))),
